                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">维护编号</label>
                          <div class="layui-input-inline">
                              <input type="text" name="changdiWeihuUuidNumber" id="changdiWeihuUuidNumber" placeholder="维护编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">场地维护类型</label>
                          <div class="layui-input-inline">
                              <select name="changdiWeihuTypes" id="changdiWeihuTypes" lay-filter="changdiWeihuTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in changdiWeihuTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            changdiWeihuTypesList : [],
            changdiWeihuTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function changdiWeihuTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=changdi_weihu_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.changdiWeihuTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#changdiWeihuUuidNumber').val() != null && jquery('#changdiWeihuUuidNumber').val() != "" && jquery('#changdiWeihuUuidNumber').val() != "null" ) {
                param['changdiWeihuUuidNumber'] = jquery('#changdiWeihuUuidNumber').val();
            }
         
            var changdiWeihuTypes = $("#changdiWeihuTypes").find("option:selected").val();
            if (changdiWeihuTypes != null && changdiWeihuTypes != "" && changdiWeihuTypes != "null") {
                param['changdiWeihuTypes'] = changdiWeihuTypes;
            }
                                

            // 获取列表数据
            http.request('changdiWeihu/list', 'get', param, function(res) {
