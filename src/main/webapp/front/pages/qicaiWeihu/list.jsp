                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="qicaiWeihuUuidNumber" id="qicaiWeihuUuidNumber" placeholder="维护编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">器材维护类型</label>
                          <div class="layui-input-inline">
                              <select name="qicaiWeihuTypes" id="qicaiWeihuTypes" lay-filter="qicaiWeihuTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in qicaiWeihuTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function qicaiWeihuTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qicai_weihu_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.qicaiWeihuTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#qicaiWeihuUuidNumber').val() != null && jquery('#qicaiWeihuUuidNumber').val() != "" && jquery('#qicaiWeihuUuidNumber').val() != "null" ) {
                param['qicaiWeihuUuidNumber'] = jquery('#qicaiWeihuUuidNumber').val();
            }
         
            var qicaiWeihuTypes = $("#qicaiWeihuTypes").find("option:selected").val();
            if (qicaiWeihuTypes != null && qicaiWeihuTypes != "" && qicaiWeihuTypes != "null") {
                param['qicaiWeihuTypes'] = qicaiWeihuTypes;
            }
                                

            // 获取列表数据
            http.request('qicaiWeihu/list', 'get', param, function(res) {
