    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiWeihuUuidNumber" id="qicaiWeihuUuidNumber" lay-verify="required" placeholder="维护编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="qicaiWeihuTypes" id="qicaiWeihuTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`qicaiWeihu/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function qicaiWeihuTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qicai_weihu_types", "GET", {}, (res) => {
					   if(res.code == 0){
