    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiOrderUuidNumber" id="qicaiOrderUuidNumber" lay-verify="required" placeholder="租赁流水号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="guihuanTime" id="guihuanTime"  lay-verify="required|date"   placeholder="归还时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiZulinTian" id="qicaiZulinTian"  lay-verify="required|integer"   placeholder="租赁天数" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiOrderTruePrice" id="qicaiOrderTruePrice"  lay-verify="required|double"   placeholder="实付金额" autocomplete="off" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<label class="layui-form-label">器材租赁状态</label>
							<div  class="layui-input-inline" style="width: 500px">
								<select name="qicaiOrderTypes" id="qicaiOrderTypes">
                                    <option v-for="item in qicaiOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`qicaiOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
