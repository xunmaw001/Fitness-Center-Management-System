    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiaolianUuidNumber" id="jiaolianUuidNumber" lay-verify="required" placeholder="教练编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiaolianName" id="jiaolianName" lay-verify="required" placeholder="教练姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiaolianPhone" id="jiaolianPhone"  lay-verify="required|phone"   placeholder="教练手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiaolianIdNumber" id="jiaolianIdNumber"  lay-verify="required|identity"   placeholder="教练身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="jiaolianPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="jiaolianPhoto" name="jiaolianPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiaolianShanchang" id="jiaolianShanchang" lay-verify="required" placeholder="教练擅长" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jiaolianShichang" id="jiaolianShichang" lay-verify="required" placeholder="任职时长" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`jiaolian/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#jiaolianPhotoImg").attr("src", data.data.jiaolianPhoto);
                });
