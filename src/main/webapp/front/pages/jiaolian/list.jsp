                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaolianUuidNumber" id="jiaolianUuidNumber" placeholder="教练编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiaolianName" id="jiaolianName" placeholder="教练姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#jiaolianUuidNumber').val() != null && jquery('#jiaolianUuidNumber').val() != "" && jquery('#jiaolianUuidNumber').val() != "null" ) {
                param['jiaolianUuidNumber'] = jquery('#jiaolianUuidNumber').val();
            }
         
            if (jquery('#jiaolianName').val() != null && jquery('#jiaolianName').val() != "" && jquery('#jiaolianName').val() != "null" ) {
                param['jiaolianName'] = jquery('#jiaolianName').val();
            }
                                                                

            // 获取列表数据
            http.request('jiaolian/list', 'get', param, function(res) {
