    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="changdiOrderUuidNumber" id="changdiOrderUuidNumber" lay-verify="required" placeholder="预约流水号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="changdiOrderTruePrice" id="changdiOrderTruePrice"  lay-verify="required|double"   placeholder="实付金额" autocomplete="off" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<label class="layui-form-label">场地预约状态</label>
							<div  class="layui-input-inline" style="width: 500px">
								<select name="changdiOrderTypes" id="changdiOrderTypes">
                                    <option v-for="item in changdiOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`changdiOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
