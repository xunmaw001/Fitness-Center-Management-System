        ...
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengUuidNumber" id="kechengUuidNumber" lay-verify="required" placeholder="课程编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengKaishiTime" id="kechengKaishiTime"  lay-verify="required|date"   placeholder="课程开始时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengJieshuTime" id="kechengJieshuTime"  lay-verify="required|date"   placeholder="课程结束时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengNumber" id="kechengNumber"  lay-verify="required|integer"   placeholder="最大报名人数" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="kechengOldMoney" id="kechengOldMoney"  placeholder="课程原价" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="kechengNewMoney" id="kechengNewMoney"  placeholder="课程现价" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengClicknum" id="kechengClicknum"  lay-verify="required|integer"   placeholder="课程热度" autocomplete="off" class="layui-input">
							</div>
						</div>
