    ...
    <ul id="category">
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="changdiName" id="changdiName" lay-verify="required" placeholder="场地名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="changdiUuidNumber" id="changdiUuidNumber" lay-verify="required" placeholder="场地编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="changdiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="changdiPhoto" name="changdiPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="changdiPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="changdiTypes" id="changdiTypes">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">场地租赁原价</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="changdiOldMoney" id="changdiOldMoney"  placeholder="场地租赁原价" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">场地租赁现价</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="changdiNewMoney" id="changdiNewMoney"  placeholder="场地租赁现价" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#changdiPhoto').val(url);
                            jquery('#changdiPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`changdi/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#changdiPhotoImg").attr("src", data.data.changdiPhoto);
                });
			   ...
			   function changdiTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=changdi_types", "GET", {}, (res) => {
					   if(res.code == 0){
