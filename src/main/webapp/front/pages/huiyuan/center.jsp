				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huiyuanUuidNumber" id="huiyuanUuidNumber" lay-verify="required" placeholder="会员编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huiyuanName" id="huiyuanName" lay-verify="required" placeholder="会员姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huiyuanPhone" id="huiyuanPhone"  lay-verify="required|phone"   placeholder="会员手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huiyuanIdNumber" id="huiyuanIdNumber"  lay-verify="required|identity"   placeholder="会员身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="huiyuanPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="huiyuanPhoto" name="huiyuanPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="huiyuanEmail" id="huiyuanEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`huiyuan/session`, 'get', {}, function (data) {
					...
					jquery("#huiyuanPhotoImg").attr("src", data.data.huiyuanPhoto);
                });
