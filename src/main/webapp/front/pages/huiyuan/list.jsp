                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huiyuanUuidNumber" id="huiyuanUuidNumber" placeholder="会员编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="huiyuanName" id="huiyuanName" placeholder="会员姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#huiyuanUuidNumber').val() != null && jquery('#huiyuanUuidNumber').val() != "" && jquery('#huiyuanUuidNumber').val() != "null" ) {
                param['huiyuanUuidNumber'] = jquery('#huiyuanUuidNumber').val();
            }
         
            if (jquery('#huiyuanName').val() != null && jquery('#huiyuanName').val() != "" && jquery('#huiyuanName').val() != "null" ) {
                param['huiyuanName'] = jquery('#huiyuanName').val();
            }
