					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zixunName" id="zixunName" lay-verify="required" placeholder="健身资讯名称" autocomplete="off" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="zixunPhotoImg"
									 style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;"
									 src="../../img/avator.png">
								<input type="hidden" id="zixunPhoto" name="zixunPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="zixunPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zixunTypes" id="zixunTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#zixunPhoto').val(url);
                            jquery('#zixunPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`zixun/session`, 'get', {}, function (data) {
					...
					jquery("#zixunPhotoImg").attr("src", data.data.zixunPhoto);
                });
			   ...
			   function zixunTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zixun_types", "GET", {}, (res) => {
					   if(res.code == 0){
