					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengOrderUuidNumber" id="kechengOrderUuidNumber" lay-verify="required" placeholder="预约流水号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengOrderTruePrice" id="kechengOrderTruePrice"  lay-verify="required|double"   placeholder="实付金额" autocomplete="off" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<label class="layui-form-label">课程预约状态</label>
							<div  class="layui-input-inline" style="width: 500px">
								<select name="kechengOrderTypes" id="kechengOrderTypes">
                                    <option v-for="item in kechengOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
