...
<div style=" width:auto; margin:-47px 10px 0px auto">
    ...
    <ul id="category">
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiName" id="qicaiName" lay-verify="required" placeholder="器材名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiUuidNumber" id="qicaiUuidNumber" lay-verify="required" placeholder="器材编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="qicaiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="qicaiPhoto" name="qicaiPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="qicaiPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="qicaiTypes" id="qicaiTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiKucunNumber" id="qicaiKucunNumber"  lay-verify="required|integer"   placeholder="器材数量" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">器材租赁原价/天</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="qicaiOldMoney" id="qicaiOldMoney"  placeholder="器材租赁原价/天" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">器材租赁现价/天</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="qicaiNewMoney" id="qicaiNewMoney"  placeholder="器材租赁现价/天" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="qicaiClicknum" id="qicaiClicknum"  lay-verify="required|integer"   placeholder="器材热度" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#qicaiPhoto').val(url);
                            jquery('#qicaiPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`qicai/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#qicaiPhotoImg").attr("src", data.data.qicaiPhoto);
                });
			   ...
			   function qicaiTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qicai_types", "GET", {}, (res) => {
					   if(res.code == 0){
