    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="youhuixinxiName" id="youhuixinxiName" lay-verify="required" placeholder="优惠信息名称" autocomplete="off" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="youhuixinxiPhotoImg"
									 style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;"
									 src="../../img/avator.png">
								<input type="hidden" id="youhuixinxiPhoto" name="youhuixinxiPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="youhuixinxiPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="youhuixinxiTypes" id="youhuixinxiTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#youhuixinxiPhoto').val(url);
                            jquery('#youhuixinxiPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`youhuixinxi/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#youhuixinxiPhotoImg").attr("src", data.data.youhuixinxiPhoto);
                });
			   ...
			   function youhuixinxiTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=youhuixinxi_types", "GET", {}, (res) => {
					   if(res.code == 0){
