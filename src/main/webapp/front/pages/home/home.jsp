            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in changdiList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../changdi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.changdiPhoto?item.changdiPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.changdiName}}</h4>
                                            </div>
                                            <b v-if="item.changdiNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.changdiNewMoney}} RMB
                                            </b>
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in youhuixinxiList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../youhuixinxi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.youhuixinxiPhoto?item.youhuixinxiPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.youhuixinxiName}}</h4>
                                            </div>
                                            <b v-if="item.youhuixinxiNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.youhuixinxiNewMoney}} RMB
                                            </b>
                                            <b v-else style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.youhuixinxiValue}}
                                            </b>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in qicaiList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../qicai/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.qicaiPhoto?item.qicaiPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.qicaiName}}</h4>
                                            </div>
                                            <b v-if="item.qicaiNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.qicaiNewMoney}} RMB
                                            </b>
                                            <b v-else style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.qicaiValue}}
                                            </b>
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in zixunList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../zixun/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.zixunPhoto?item.zixunPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.zixunName}}</h4>
                                            </div>
                                            <b v-if="item.zixunNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.zixunNewMoney}} RMB
                                            </b>
                                            <b v-else style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.zixunValue}}
                                            </b>
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="team agileits" id="team">
                        <div class="team-info">
                            <div class="team-row">
                                <div v-for="(item,index) in kechengList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 team-grids">
                                    <div class="team-agile-img" @click="jumpCheck('../kecheng/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img :src="item.kechengPhoto?item.kechengPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <div class="view-caption">
                                            <div class="w3ls-info">
                                                <h4>{{item.kechengName}}</h4>
                                            </div>
                                            <b v-if="item.kechengNewMoney" style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.kechengNewMoney}} RMB
                                            </b>
                                            <b v-else style="float: right;display: inline-block;color: #FFFFFF;font-size: 17px;">
                                                {{item.kechengValue}}
                                            </b>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request('youhuixinxi/list', 'get', {
            page: 1,
            limit: 8,
        }, function (res) {
            vue.youhuixinxiList = res.data.list;
            vue.$nextTick(() => {
        ...
        http.request(`qicai/list`, 'get', {
            page: 1,
            limit: 8,
            orderBy: 'qicai_clicknum',
            shangxiaTypes: 1,
            qicaiDelete: 1,
        }, function (res) {
            vue.qicaiList = res.data.list;
        });
