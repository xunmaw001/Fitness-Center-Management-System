...
var centerMenu = [
    ...
    ,{
        name: '场地收藏',
        url: '../changdiCollection/list.jsp'
    }
    ,{
        name: '场地预约',
        url: '../changdiOrder/list.jsp'
    }
    ,{
        name: '课程收藏',
    ...
    ,{
        name: '器材收藏',
        url: '../qicaiCollection/list.jsp'
    }
    ,{
        name: '器材租赁',
        url: '../qicaiOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '器材',
        url: './pages/qicai/list.jsp'
    },
    {
        name: '优惠信息',
        url: './pages/youhuixinxi/list.jsp'
    },
    {
        name: '健身资讯',
...
var adminurl =  "http://localhost:8080/jianshenzhongxinguanli/jsp/login.jsp";
