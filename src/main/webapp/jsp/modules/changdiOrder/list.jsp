...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">场地预约管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">场地预约列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">场地预约列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="changdiOrderUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        场地预约状态
                                        <div class="layui-input-inline">
                                            <select name="changdiOrderTypesSelectSearch"  style="width: 150px;" id="changdiOrderTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //预约流水号
            var changdiOrderUuidNumberSearchInput = $('#changdiOrderUuidNumberSearch');
            if( changdiOrderUuidNumberSearchInput != null){
                if (changdiOrderUuidNumberSearchInput.val() != null && changdiOrderUuidNumberSearchInput.val() != '') {
                    searchForm.changdiOrderUuidNumber = $('#changdiOrderUuidNumberSearch').val();
                }
            }
                     
                //场地预约状态
            var changdiOrderTypesSelectSearchInput = document.getElementById("changdiOrderTypesSelectSearch");
            if(changdiOrderTypesSelectSearchInput != null){
                var changdiOrderTypesIndex = changdiOrderTypesSelectSearchInput.selectedIndex;
                if( changdiOrderTypesIndex  != 0){
                    searchForm.changdiOrderTypes= document.getElementById("changdiOrderTypesSelectSearch").options[changdiOrderTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("changdiOrder/page", "GET", {
                ...
                //本表的
                changdiOrderUuidNumber: searchForm.changdiOrderUuidNumber,
                changdiOrderTypes: searchForm.changdiOrderTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //预约流水号
            var changdiOrderUuidNumberCell = document.createElement('td');
            changdiOrderUuidNumberCell.innerHTML = item.changdiOrderUuidNumber;
            row.appendChild(changdiOrderUuidNumberCell);
            ...
            //实付金额
            var changdiOrderTruePriceCell = document.createElement('td');
            changdiOrderTruePriceCell.innerHTML = item.changdiOrderTruePrice;
            row.appendChild(changdiOrderTruePriceCell);


            //场地预约状态
            var changdiOrderTypesCell = document.createElement('td');
            changdiOrderTypesCell.innerHTML = item.changdiOrderValue;
            row.appendChild(changdiOrderTypesCell);
            ...
            if(item.changdiOrderTypes == 1 && window.sessionStorage.getItem('role') == "会员"){
                //退款
            ...
            if(item.changdiOrderTypes == 1 && (window.sessionStorage.getItem('role') == "管理员" || window.sessionStorage.getItem('role') == "员工")){
                //确认使用
                var detailListBtn = document.createElement('button');
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("changdiOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchangdiOrder", "addchangdiOrder");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function changdiOrderTypesSelectSearch() {
            var changdiOrderTypesSelectSearch = document.getElementById('changdiOrderTypesSelectSearch');
            if(changdiOrderTypesSelectSearch != null) {
                changdiOrderTypesSelectSearch.add(new Option('-请选择-',''));
                if (changdiOrderTypesOptions != null && changdiOrderTypesOptions.length > 0){
                    for (var i = 0; i < changdiOrderTypesOptions.length; i++) {
                            changdiOrderTypesSelectSearch.add(new Option(changdiOrderTypesOptions[i].indexName,changdiOrderTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
        ...
        function refund(id) {
            ...
            http("changdiOrder/refund?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('退款成功');
                    getDataList();
                }else{
        ...
        function deliver(id) {
            ...
            http("changdiOrder/deliver?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('成功确认使用');
                    getDataList();
                }else{
