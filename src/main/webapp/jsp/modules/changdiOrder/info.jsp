            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">场地预约登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="changdiOrderUuidNumber" name="changdiOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.changdiOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="huiyuanId" name="huiyuanId" v-model="ruleForm.huiyuanId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="changdiOrderTruePrice" name="changdiOrderTruePrice" class="form-control"
                                               v-model="ruleForm.changdiOrderTruePrice" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>场地预约状态</label>
                                    <input style="width: 450px" id="changdiOrderValue" name="changdiOrderValue" class="form-control"
                                           v-model="ruleForm.changdiOrderValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "changdiOrder/info/" + id,
