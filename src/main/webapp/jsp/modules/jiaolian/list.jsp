...
<!--/Pre Loader -->
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //教练擅长
            var jiaolianShanchangCell = document.createElement('td');
            jiaolianShanchangCell.innerHTML = item.jiaolianShanchang;
            row.appendChild(jiaolianShanchangCell);


            //任职时长
            var jiaolianShichangCell = document.createElement('td');
            jiaolianShichangCell.innerHTML = item.jiaolianShichang;
            row.appendChild(jiaolianShichangCell);
