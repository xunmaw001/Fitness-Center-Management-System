...
<body style="background-image:url('/jianshenzhongxinguanli/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>会员编号</label>
                                    <input id="huiyuanUuidNumber" name="huiyuanUuidNumber" class="form-control"
                                           placeholder="会员编号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>会员姓名</label>
                                ...
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>
                                    <input id="huiyuanEmail" name="huiyuanEmail" class="form-control"
                                           placeholder="电子邮箱">
                                </div>
                                <div class="form-group col-md-12">
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("huiyuan/register", "POST", data, (res) => {
                    if(res.code == 0){
