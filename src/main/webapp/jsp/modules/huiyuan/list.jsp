...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="huiyuanUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="会员编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //会员编号
            var huiyuanUuidNumberCell = document.createElement('td');
            huiyuanUuidNumberCell.innerHTML = item.huiyuanUuidNumber;
            row.appendChild(huiyuanUuidNumberCell);
            ...
            //电子邮箱
            var huiyuanEmailCell = document.createElement('td');
            huiyuanEmailCell.innerHTML = item.huiyuanEmail;
            row.appendChild(huiyuanEmailCell);
        ...
        function resetPassword(id) {
            http("huiyuan/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
                    getDataList();
