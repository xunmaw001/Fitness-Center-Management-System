                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 huiyuanUuidNumberDiv">
                                        <label>会员编号</label>
                                        <input style="width: 450px" id="huiyuanUuidNumber" name="huiyuanUuidNumber" class="form-control"
                                               placeholder="会员编号">
                                    </div>
                                    <div class="form-group col-md-6 huiyuanNameDiv">
                                        <label>会员姓名</label>
                                        <input style="width: 450px" id="huiyuanName" name="huiyuanName" class="form-control"
                                               placeholder="会员姓名">
                                    </div>
                                    <div class="form-group col-md-6 huiyuanPhoneDiv">
                                        <label>会员手机号</label>
                                        <input style="width: 450px" id="huiyuanPhone" name="huiyuanPhone" class="form-control"
                                               onchange="huiyuanPhoneChickValue(this)"  placeholder="会员手机号">
                                    </div>
                                    <div class="form-group col-md-6 huiyuanIdNumberDiv">
                                        <label>会员身份证号</label>
                                        <input style="width: 450px" id="huiyuanIdNumber" name="huiyuanIdNumber" class="form-control"
                                               onchange="huiyuanIdNumberChickValue(this)"  placeholder="会员身份证号">
                                    </div>
                                    <div class="form-group col-md-6 huiyuanPhotoDiv">
                                        <label>会员头像</label>
                                    ...
                                    <div class="form-group col-md-6 huiyuanEmailDiv">
                                        <label>电子邮箱</label>
                                        <input style="width: 450px" id="huiyuanEmail" name="huiyuanEmail" class="form-control"
                                               placeholder="电子邮箱">
                                    </div>
...
<script>
    ...
    function getDetails() {
        ...
        if (addhuiyuan != null && addhuiyuan != "" && addhuiyuan != "null") {
            //注册表单验证
            $(validform());
            $("#huiyuanUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
