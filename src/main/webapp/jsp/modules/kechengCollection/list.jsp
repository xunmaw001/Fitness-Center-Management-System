...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var kechengCollectionTypesCell = document.createElement('td');
            kechengCollectionTypesCell.innerHTML = item.kechengCollectionValue;
            row.appendChild(kechengCollectionTypesCell);
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'kechengCollection.xlsx'
            });
            excel.generate();
        }
