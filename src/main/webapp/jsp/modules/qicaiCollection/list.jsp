...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">器材收藏管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">器材收藏列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">器材收藏列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("qicaiCollection/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                qicaiCollectionDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var qicaiCollectionTypesCell = document.createElement('td');
            qicaiCollectionTypesCell.innerHTML = item.qicaiCollectionValue;
            row.appendChild(qicaiCollectionTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("qicaiCollection/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addqicaiCollection", "addqicaiCollection");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'qicaiCollection.xlsx'
            });
            excel.generate();
        }
