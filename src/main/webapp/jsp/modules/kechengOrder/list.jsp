...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">课程预约管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">课程预约管理</li>
                            <li class="breadcrumb-item active">课程预约列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">课程预约列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="kechengOrderUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        课程预约状态
                                        <div class="layui-input-inline">
                                            <select name="kechengOrderTypesSelectSearch"  style="width: 150px;" id="kechengOrderTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //预约流水号
            var kechengOrderUuidNumberSearchInput = $('#kechengOrderUuidNumberSearch');
            if( kechengOrderUuidNumberSearchInput != null){
                if (kechengOrderUuidNumberSearchInput.val() != null && kechengOrderUuidNumberSearchInput.val() != '') {
                    searchForm.kechengOrderUuidNumber = $('#kechengOrderUuidNumberSearch').val();
                }
            }
                 
                //课程预约状态
            var kechengOrderTypesSelectSearchInput = document.getElementById("kechengOrderTypesSelectSearch");
            if(kechengOrderTypesSelectSearchInput != null){
                var kechengOrderTypesIndex = kechengOrderTypesSelectSearchInput.selectedIndex;
                if( kechengOrderTypesIndex  != 0){
                    searchForm.kechengOrderTypes= document.getElementById("kechengOrderTypesSelectSearch").options[kechengOrderTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("kechengOrder/page", "GET", {
                ...
                sort: sortColumn,
                order: sortOrder,
                kechengOrderDelete: 1,
                //本表的
                kechengOrderUuidNumber: searchForm.kechengOrderUuidNumber,
                kechengOrderTypes: searchForm.kechengOrderTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //预约流水号
            var kechengOrderUuidNumberCell = document.createElement('td');
            kechengOrderUuidNumberCell.innerHTML = item.kechengOrderUuidNumber;
            row.appendChild(kechengOrderUuidNumberCell);


            //实付金额
            var kechengOrderTruePriceCell = document.createElement('td');
            kechengOrderTruePriceCell.innerHTML = item.kechengOrderTruePrice;
            row.appendChild(kechengOrderTruePriceCell);


            //课程预约状态
            var kechengOrderTypesCell = document.createElement('td');
            kechengOrderTypesCell.innerHTML = item.kechengOrderValue;
            row.appendChild(kechengOrderTypesCell);
            ...
            if(item.kechengOrderTypes == 1 && window.sessionStorage.getItem('role') == "会员"){
                //退款
            ...
            if(item.kechengOrderTypes == 1 && (window.sessionStorage.getItem('role') == "管理员" || window.sessionStorage.getItem('role') == "员工")){
                //确认使用
                var detailListBtn = document.createElement('button');
    ...
    //填充本表搜索下拉框
        ...
        function kechengOrderTypesSelectSearch() {
            var kechengOrderTypesSelectSearch = document.getElementById('kechengOrderTypesSelectSearch');
            if(kechengOrderTypesSelectSearch != null) {
                kechengOrderTypesSelectSearch.add(new Option('-请选择-',''));
                if (kechengOrderTypesOptions != null && kechengOrderTypesOptions.length > 0){
                    for (var i = 0; i < kechengOrderTypesOptions.length; i++) {
                            kechengOrderTypesSelectSearch.add(new Option(kechengOrderTypesOptions[i].indexName,kechengOrderTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function kechengOrderTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=kecheng_order_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        kechengOrderTypesOptions = res.data.list;
                    }
                });
            }
        ...
        function refund(id) {
            ...
            http("kechengOrder/refund?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('退款成功');
                    getDataList();
                }else{
        ...
        // 确认使用
        function deliver(id) {
            var mymessage = confirm("确定要确认使用吗？");
            if(!mymessage){
                alert("已取消操作");
                return false;
            }
            http("kechengOrder/deliver?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('成功确认使用');
                    getDataList();
                }else{
