            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">器材租赁登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="qicaiOrderUuidNumber" name="qicaiOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.qicaiOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="huiyuanId" name="huiyuanId" v-model="ruleForm.huiyuanId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>归还时间</label>
                                        <input style="width: 450px" id="guihuanTime" name="guihuanTime" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="qicaiZulinTian" name="qicaiZulinTian" class="form-control"
                                               v-model="ruleForm.qicaiZulinTian" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="qicaiOrderTruePrice" name="qicaiOrderTruePrice" class="form-control"
                                               v-model="ruleForm.qicaiOrderTruePrice" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>器材租赁状态</label>
                                    <input style="width: 450px" id="qicaiOrderValue" name="qicaiOrderValue" class="form-control"
                                           v-model="ruleForm.qicaiOrderValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "qicaiOrder/info/" + id,
