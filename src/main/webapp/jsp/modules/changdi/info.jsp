            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">场地登记</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.changdiContent != null && ruleForm.changdiContent != 'null' && ruleForm.changdiContent != '') {
            var changdiContentUeditor = UE.getEditor('changdiContentEditor');
                changdiContentUeditor.ready(function () {
                    ...
                    changdiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
