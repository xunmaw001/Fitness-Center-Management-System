...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">场地列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //场地租赁原价
            var changdiOldMoneyCell = document.createElement('td');
            changdiOldMoneyCell.innerHTML = item.changdiOldMoney;
            row.appendChild(changdiOldMoneyCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("changdi/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchangdi", "addchangdi");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function shangxia(id,shangxiaTypes) {
            ...
            httpJson("changdi/update", "POST", data, (res) => {
                if(res.code == 0){
                    alert(msg);
                    getDataList()
                }else{
