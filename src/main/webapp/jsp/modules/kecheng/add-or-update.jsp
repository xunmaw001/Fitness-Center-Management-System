                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="jiaolianId" name="jiaolianId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 kechengKaishiTimeDiv">
                                        <label>课程开始时间</label>
                                        <input style="width: 450px" id="kechengKaishiTime-input" name="kechengKaishiTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6 kechengJieshuTimeDiv">
                                        <label>课程结束时间</label>
                                        <input style="width: 450px" id="kechengJieshuTime-input" name="kechengJieshuTime" type="text" class="form-control layui-input">
                                    </div>
                                    <div class="form-group col-md-6 kechengNumberDiv">
                                        <label>最大报名人数</label>
                                        <input style="width: 450px" id="kechengNumber" name="kechengNumber" class="form-control"
                                               onchange="kechengNumberChickValue(this)"  placeholder="最大报名人数">
                                    </div>

                                    <div class="form-group col-md-6 kechengOldMoneyDiv">
                                        <label>课程原价</label>
                                        <input style="width: 450px" id="kechengOldMoney" name="kechengOldMoney" class="form-control"
                                               onchange="kechengOldMoneyChickValue(this)" placeholder="课程原价">
                                    </div>
                                    <div class="form-group col-md-6 kechengNewMoneyDiv">
                                        <label>课程现价</label>
                                        <input style="width: 450px" id="kechengNewMoney" name="kechengNewMoney" class="form-control"
                                               onchange="kechengNewMoneyChickValue(this)" placeholder="课程现价">
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function kechengNumberChickValue(e){
        ...
        function kechengOldMoneyChickValue(e){
            var this_val = e.value || 0;
        ...
        function kechengNewMoneyChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[0-9]{0,6}(\.[0-9]{1,2})?$/;
            if(!reg.test(this_val)){
                e.value = "";
        ...
        function kechengClicknumChickValue(e){
            var this_val = e.value || 0;
            var reg=/^[1-9][0-9]*$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                kechengKaishiTime: "required",
                kechengJieshuTime: "required",
                kechengNumber: "required",
                // kechengOldMoney: "required",
                // kechengNewMoney: "required",
                kechengClicknum: "required",
            ...
            messages: {
                ...
                kechengKaishiTime: "课程开始时间不能为空",
                kechengJieshuTime: "课程结束时间不能为空",
                kechengNumber: "最大报名人数不能为空",
                // kechengOldMoney: "课程原价不能为空",
                // kechengNewMoney: "课程现价不能为空",
                kechengClicknum: "课程热度不能为空",
    ...
    function dateTimePick() {
        var kechengKaishiTime = laydate.render({
            elem: '#kechengKaishiTime-input'
            ,type: 'datetime'
        });
        var kechengJieshuTime = laydate.render({
            elem: '#kechengJieshuTime-input'
            ,type: 'datetime'
        });
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#kechengKaishiTime-input").val(ruleForm.kechengKaishiTime);
        $("#kechengJieshuTime-input").val(ruleForm.kechengJieshuTime);
    ...
    function jiaolianDataBind(){
        ...
        $("#jiaolianShanchang").val(ruleForm.jiaolianShanchang);
        $("#jiaolianShichang").val(ruleForm.jiaolianShichang);
        $("#jiaolianContent").val(ruleForm.jiaolianContent);
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 课程原价设置不可选
            $('#kechengOldMoney').attr('readonly', 'readonly');
            // 课程现价设置不可选
            $('#kechengNewMoney').attr('readonly', 'readonly');
        }
