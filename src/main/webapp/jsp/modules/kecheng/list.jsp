...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        教练编号
                                        <div class="layui-input-inline">
                                            <input type="text" id="jiaolianUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="教练编号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
                            ...
                            //教练编号
            var jiaolianUuidNumberSearchInput = $('#jiaolianUuidNumberSearch');
            if( jiaolianUuidNumberSearchInput != null){
                if (jiaolianUuidNumberSearchInput.val() != null && jiaolianUuidNumberSearchInput.val() != '') {
                    searchForm.jiaolianUuidNumber = $('#jiaolianUuidNumberSearch').val();
                }
            }
        ...
        function getDataList() {
            ...
            //级联表的
                jiaolianUuidNumber: searchForm.jiaolianUuidNumber,
        ...
        function setDataRow(item, number) {
            ...
            //课程开始时间
            var kechengKaishiTimeCell = document.createElement('td');
            kechengKaishiTimeCell.innerHTML = item.kechengKaishiTime;
            row.appendChild(kechengKaishiTimeCell);


            //课程结束时间
            var kechengJieshuTimeCell = document.createElement('td');
            kechengJieshuTimeCell.innerHTML = item.kechengJieshuTime;
            row.appendChild(kechengJieshuTimeCell);


            //最大报名人数
            var kechengNumberCell = document.createElement('td');
            kechengNumberCell.innerHTML = item.kechengNumber;
            row.appendChild(kechengNumberCell);


            //课程原价
            var kechengOldMoneyCell = document.createElement('td');
            kechengOldMoneyCell.innerHTML = item.kechengOldMoney;
            row.appendChild(kechengOldMoneyCell);


            //课程现价
            var kechengNewMoneyCell = document.createElement('td');
            kechengNewMoneyCell.innerHTML = item.kechengNewMoney;
            row.appendChild(kechengNewMoneyCell);


            //课程热度
            var kechengClicknumCell = document.createElement('td');
            kechengClicknumCell.innerHTML = item.kechengClicknum;
            row.appendChild(kechengClicknumCell);
