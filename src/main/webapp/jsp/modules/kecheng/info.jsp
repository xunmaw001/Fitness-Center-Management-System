                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jiaolianId" name="jiaolianId" v-model="ruleForm.jiaolianId" readonly type="hidden">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>课程开始时间</label>
                                        <input style="width: 450px" id="kechengKaishiTime" name="kechengKaishiTime" class="form-control"
                                               v-model="ruleForm.kechengKaishiTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>课程结束时间</label>
                                        <input style="width: 450px" id="kechengJieshuTime" name="kechengJieshuTime" class="form-control"
                                               v-model="ruleForm.kechengJieshuTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengNumber" name="kechengNumber" class="form-control"
                                               v-model="ruleForm.kechengNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengOldMoney" name="kechengOldMoney" class="form-control"
                                               v-model="ruleForm.kechengOldMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengNewMoney" name="kechengNewMoney" class="form-control"
                                               v-model="ruleForm.kechengNewMoney" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>课程热度</label>
                                        <input style="width: 450px" id="kechengClicknum" name="kechengClicknum" class="form-control"
                                               v-model="ruleForm.kechengClicknum" readonly>
                                    </div>
