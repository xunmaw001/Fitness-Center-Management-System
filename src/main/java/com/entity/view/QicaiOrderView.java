...
public class QicaiOrderView extends QicaiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 器材租赁状态的值
		*/
		private String qicaiOrderValue;
	...
	public QicaiOrderView() {

	}

	public QicaiOrderView(QicaiOrderEntity qicaiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, qicaiOrderEntity);
			...
			* 获取： 器材租赁状态的值
			*/
			public String getQicaiOrderValue() {
				return qicaiOrderValue;
			}
			/**
			* 设置： 器材租赁状态的值
			*/
			public void setQicaiOrderValue(String qicaiOrderValue) {
				this.qicaiOrderValue = qicaiOrderValue;
			}
